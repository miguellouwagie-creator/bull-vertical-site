...
export const Services = () => {
  ...
  // ⬇️ Leemos del diccionario; si aún no añadiste services.items, usamos tu contenido actual como fallback
  const dict = (translations as any)[lang]?.services ?? {};
  ...
  const selectedLabel: string = dict.selectedLabel ?? "Selected services:";
  const quoteSelectedCta: string =
    dict.quoteSelectedCta ?? "Quote for Selected Services";
